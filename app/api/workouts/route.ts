...
const library: Record<string, Exercise[]> = {
  MMA: [
    ...
    { key: "copenhagen", name: "Copenhagen plank", equipment: ["bench", "full gym", "bodyweight"], substitute: "Side plank with top-leg lift", sets: 3, reps: "20 sec each side", repMax: 20, rest: "45 sec", target: "Controlled", why: "Builds groin and trunk strength.", helps: "Clinch pressure and takedown defence", intensity: "controlled" },
